...
TEXT = {
    ...
    "predict_usage": {
        "uk": "📊 Напишіть команду у форматі:\n/predict BTCUSDT",
        "ru": "📊 Напишите команду в формате:\n/predict BTCUSDT",
        "en": "📊 Write command like:\n/predict BTCUSDT"
    },
    "predict_error": {
        "uk": "❌ Помилка отримання даних або прогнозу.",
        "ru": "❌ Ошибка получения данных или прогноза.",
        "en": "❌ Error fetching data or forecast."
    }
}
...
async def handle_cb(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("lang:"):
        ...
        # Автоматично даємо доступ 1 годину (можна змінити)
        add_or_update_user(uid, 0.0417)  # 1 година ~ 1/24 дня
